...
!(function (e, t) {
    ...
    (V.RegisterPlugins = function (e) {
        ...
        Object.assign(V, { DEFAULTS: { initOnClick: !1, pluginsEnabled: null }, MODULES: {}, PLUGINS: {}, VERSION: "3.2.0", INSTANCES: [], OPTS_MAPPING: {}, SHARED: {}, ID: 0 }),
    ...
    (V.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}")),
            ...
            return {
                _startEnter: function b(e) {
                    ...
                    if (g.node.isEmpty(n, !0) && r) {
                        ...
                        (t = v(n)).parentNode && "LI" === t.parentNode.tagName
                            ? r
                                ? C(t.parentNode).before("".concat(g.node.openTagString(n) + V.MARKERS, "<br></li>"))
                                : C(t.parentNode).after("".concat(g.node.openTagString(n) + V.MARKERS, "<br></li>"))
                            : i
                            ? C(t).before("<".concat(i, ">").concat(V.MARKERS, "<br></").concat(i, ">"))
                            : C(t).before("".concat(V.MARKERS, "<br>")),
                            C(n).remove();
                },
                ...
                _backspace: function d(e) {
                    ...
                    if (n) {
                        ...
                        r.length && "BR" === r[r.length - 1].tagName && C(r[r.length - 1]).remove(),
                            C(t)
                ...
                _del: function f(e) {
                    var t,
                        ...
                        r = n.nextSibling;
                    if (r) {
                        (t = g.node.contents(r)).length && "BR" === t[0].tagName && C(t[0]).remove(),
                            C(r)
                                .find(g.html.blockTagsQuery())
                                .not("ol, ul, table")
                                .each(function () {
                        ...
                        if (((s = s.nextSibling), g.node.isBlock(s)))
                            V.NO_DELETE_TAGS.indexOf(s.tagName) < 0 &&
                                (C(e).replaceWith(V.MARKERS), (t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && C(t[t.length - 1]).remove(), C(n).append(C(s).html()), C(s).remove());
                        else
                            for ((t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && C(t[t.length - 1]).remove(), C(e).replaceWith(V.MARKERS); s && !g.node.isBlock(s) && "BR" !== s.tagName; )
        ...
        (V.MODULES.cursor = function (u) {
            ...
            function C(e, t) {
                return (
                    ...
                    (e.nextSibling && e.nextSibling.nodeType === Node.TEXT_NODE && 0 === e.nextSibling.textContent.replace(/\u200b/g, "").length
                        ? C(e.nextSibling, t)
                        : !(e.nextSibling && (!e.previousSibling || "BR" !== e.nextSibling.tagName || e.nextSibling.nextSibling)) && (e.parentNode === t || C(e.parentNode, t)))
                );
            }
            function c(e) {
                ...
                _init: function x() {
                    ...
                    for (var n, r, o, i = !(f.ul = !0), a = 0, s = 0; s < e.length; s++) {
                        ...
                        if (c === N(p(N("LGnD1KNZf1CPBYCAZB-8F3UDSLLSG1VFf1A3C2=="))) || 0 <= c.indexOf(M, c.length - M.length) || C(M) || m()) {
                            if (
                                (null !== (n = l[1]) && !(0 == n.indexOf("TRIAL") ? ((n = new Date(n.replace(/TRIAL/, ""))), new Date(n) < new Date() && ((E = y), 1)) : new Date(n) < new Date(N(S)))) ||
                                !(0 < (M || "").length) ||
                                C(M) ||
                                m()
                            ) {
                    ...
                    var d = new Image();
                    !0 === f.ul && (g(), (d.src = i ? "".concat(p(N(t)), "e=").concat(a) : "".concat(p(N(t)), "u"))),
                        !0 === f.ul &&
        ...
        (V.MODULES.format = function (v) {
            ...
            function n(e, t) {
                ...
                if ((void 0 === t && (t = {}), t.style && delete t.style, v.selection.isCollapsed())) {
                    v.markers.insert(),
                        v.$el.find(".fr-marker").replaceWith(
                            f(e, t) +
                                V.INVISIBLE_SPACE +
                                V.MARKERS +
                                (function a(e) {
            ...
            function y(e, t, n, r) {
                if (!r) {
                    var o = !1;
                    if (!0 === e.data("type")) for (; v.node.isFirstSibling(e.get(0)) && !e.parent().is(v.$el) && !e.parent().is("ol") && !e.parent().is("ul"); ) e.parent().before(e), (o = !0);
                    else if (!1 === e.data("type")) for (; v.node.isLastSibling(e.get(0)) && !e.parent().is(v.$el) && !e.parent().is("ol") && !e.parent().is("ul"); ) e.parent().after(e), (o = !0);
                    if (o) return !0;
                }
                if (e.parents(t).length || void 0 === t) {
                    ...
                    return (
                        ...
                        (i = l.html().replace(/<span id="mark"><\/span>/, a + v.node.closeTagString(l.get(0)) + s + c + a + v.node.openTagString(l.get(0)) + s)),
                        l.replaceWith(v.node.openTagString(l.get(0)) + i + v.node.closeTagString(l.get(0))),
                        !0
                    );
                }
                return !1;
            ...
            function r(e, t) {
                        ...
                        if ((a.innerHTML && 8203 == a.innerHTML.charCodeAt() && a.tagName.toLocaleLowerCase() == n && (a.outerHTML = a.innerHTML), v.node.hasClass(a, "fr-marker"))) t = (t + 1) % 2;
                            ...
                            if (0 < b(a).find(".fr-marker").length) t = C(b(a), t, n, r);
                                ...
                                for (var s = b(a).find(n || "*:not(br)"), l = s.length - 1; 0 <= l; l--) {
                                    var c = s[l];
                                    v.node.isBlock(c) || v.node.isVoid(c) || (void 0 !== n && !E(c, L(n, r)))
                                        ? v.node.isBlock(c) && void 0 === n && "TABLE" !== a.tagName && v.node.clearAttributes(c)
                                        : v.node.hasClass(c, "fr-clone") || (c.outerHTML = c.innerHTML);
                                }
                                (void 0 === n && a.nodeType === Node.ELEMENT_NODE && !v.node.isVoid(a)) || E(a, L(n, r))
                                    ? v.node.isBlock(a) || v.node.hasClass(a, "fr-clone") || (a.outerHTML = a.innerHTML)
                                    : void 0 === n && a.nodeType === Node.ELEMENT_NODE && v.node.isBlock(a) && "TABLE" !== a.tagName && v.node.clearAttributes(a);
                            }
                        else 0 < b(a).find(".fr-marker").length && (t = C(b(a), t, n, r));
                    }
                    return t;
                })(v.$el, 0, e, t),
                    n || (v.$el.find(".fr-marker").remove(), v.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")),
                    n && v.$el.find(".fr-marker").before(V.INVISIBLE_SPACE).after(V.INVISIBLE_SPACE),
                ...
                if (l) {
                    var c = v.node.blockParent(l),
                        ...
                        p = f.startOffset,
                        u = f.endOffset;
                    v.selection.text().replace(/\u200B/g, "").length ||
                        (function m(e, t) {
                            if (e && t) {
                ...
                if (v.selection.isCollapsed()) {
                    ...
                    if (v.node.openTagString(l.get(0)) === '<span style="'.concat(e, ": ").concat(l.css(e), ';">')) {
                        if (v.node.isEmpty(l.get(0))) (s = b(v.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS))), l.replaceWith(s);
                            ...
                            (c["style*"] = "".concat(e, ":")),
                                y(r, "span", c, !0),
                                (r = v.$el.find(".fr-marker")),
                                t
                                    ? ((s = b(v.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS))), r.replaceWith(s))
                                    : r.replaceWith(V.INVISIBLE_SPACE + V.MARKERS);
                        }
                        v.html.cleanEmptyTags();
                    } else
                        v.node.isEmpty(l.get(0)) && l.is("span")
                            ? (r.replaceWith(V.MARKERS), l.css(e, t))
                            : ((s = b('<span style="'.concat(e, ": ").concat(t, ';">').concat(V.INVISIBLE_SPACE).concat(V.MARKERS, "</span>"))), r.replaceWith(s));
                    s && m(s, e, t);
                } else {
                    if ((v.selection.save(), null === t || ("color" === e && 0 < v.$el.find(".fr-marker").parents("u, a").length))) {
                        ...
                        for (n = 0; n < d.length; n++)
                            ...
                            else for (; v.node.isLastSibling(r.get(0)) && !r.parent().is(v.$el) && !v.node.isElement(r.parent().get(0)) && !v.node.isBlock(r.parent().get(0)); ) r.parent().after(r);
                    }
                    ...
                    for (
                        t && (p.style = "".concat(e, ": ").concat(t, ";")),
                            C(f, "span", p),
                            v.$el.find(".fr-marker + .fr-unprocessed").each(function () {
                                b(this).prepend(b(this).prev());
                            }),
                            v.$el.find(".fr-unprocessed + .fr-marker").each(function () {
                                b(this).prev().append(b(this));
                            }),
                            (t || "").match(/\dem$/) && v.$el.find("span.fr-unprocessed").removeClass("fr-unprocessed");
                        0 < v.$el.find("span.fr-unprocessed").length;
            ...
            function m(e, t, n) {
                var r,
                    o,
                    i,
                    a = e.parentsUntil(v.$el, "span[style]"),
                    s = [];
                for (r = a.length - 1; 0 <= r; r--)
                    (o = a[r]), (i = t), 0 === b(o).attr("style").indexOf("".concat(i, ":")) || 0 <= b(o).attr("style").indexOf(";".concat(i, ":")) || 0 <= b(o).attr("style").indexOf("; ".concat(i, ":")) || s.push(a[r]);
                if ((a = a.not(s)).length) {
                    for (
                        var l = "", c = "", d = "", f = "", p = e.get(0);
                        (p = p.parentNode),
                            b(p).addClass("fr-split"),
                            (l += v.node.closeTagString(p)),
                            (c = v.node.openTagString(b(p).clone().addClass("fr-split").get(0)) + c),
                            a.get(0) !== p && ((d += v.node.closeTagString(p)), (f = v.node.openTagString(b(p).clone().addClass("fr-split").get(0)) + f)),
                            a.get(0) !== p;
                            ...
                            if (!l) {
                                ...
                                (v =
                                    (E.browser.chrome || E.browser.edge) && o.nextSibling === a
                                        ? ((m = N(a, i, !0) || i.setStartAfter(a)), N(o, i, !1) || i.setEndBefore(o))
                                        : (o.previousSibling === a && (a = (o = a).nextSibling),
                                          ...
                                          (m = N(o, i, !0) || (y(o).before(s) && i.setStartBefore(o))),
                                ...
                                if (d) {
                                    if (l && (!c || c !== d)) {
                                        ...
                                        if ((f && 0 <= ["UL", "OL"].indexOf(f.tagName) && (u = !(f = null)), p && 0 <= ["UL", "OL"].indexOf(p.tagName) && (h = !(p = null)), y(l).after(d), f !== p))
                                            if (null !== f || u)
                                                if (null !== p || h || 0 !== y(f).parentsUntil(E.$el, "table").length)
                                                    f &&
                                                        p &&
                        ...
                        for (e = 0; e < o.length; e++) {
                            ...
                            for (var l = [], c = a; c !== s && c !== E.el; )
                                l.indexOf(c) < 0 && c.children && c.children.length ? (l.push(c), (c = c.children[0])) : c.nextSibling ? (c = c.nextSibling) : c.parentNode && ((c = c.parentNode), l.push(c)),
                                    E.node.isBlock(c) && l.indexOf(c) < 0 && n.indexOf(c) < 0 && (c !== s || 0 < i.endOffset) && n.push(c);
        ...
        (V.MODULES.html = function (O) {
            ...
            function e(e) {
                ...
                (r = h.merge(r, O.opts.htmlAllowedEmptyTags)),
                    (r = void 0 === e ? h.merge(r, V.BLOCK_TAGS) : h.merge(r, V.NO_DELETE_TAGS)),
                ...
                if ((t && (n = "div"), n)) {
                    for (var r = O.doc.createDocumentFragment(), o = null, i = !1, a = e.firstChild, s = !1; a; ) {
                        ...
                        if (a.nodeType === Node.ELEMENT_NODE && (O.node.isBlock(a) || (0 <= O.opts.htmlDoNotWrapTags.indexOf(a.tagName.toLowerCase()) && !O.node.hasClass(a, "fr-marker")))) (o = null), r.appendChild(a.cloneNode(!0));
                            ...
                            null === o
                                ? ((o = O.doc.createElement(n)), (s = !0), t && (o.setAttribute("class", "fr-temp-div"), o.setAttribute("data-empty", !0)), o.appendChild(a.cloneNode(!0)), r.appendChild(o))
                                : !1 === i && (o.appendChild(O.doc.createElement("br")), t && (o.setAttribute("class", "fr-temp-div"), o.setAttribute("data-empty", !0))),
                                (o = null);
                        else {
                            var c = a.textContent;
                            a.nodeType !== Node.TEXT_NODE || 0 < c.replace(/\n/g, "").replace(/(^ *)|( *$)/g, "").length || (c.replace(/(^ *)|( *$)/g, "").length && c.indexOf("\n") < 0)
                                ? (null === o && ((o = O.doc.createElement(n)), (s = !0), t && o.setAttribute("class", "fr-temp-div"), r.appendChild(o), (i = !1)),
                                  o.appendChild(a.cloneNode(!0)),
                                  i || O.node.hasClass(a, "fr-marker") || (a.nodeType === Node.TEXT_NODE && 0 === c.replace(/ /g, "").length) || (i = !0))
                                : (s = !0);
                        }
                        a = l;
                    }
            ...
            function c(e) {
                ...
                if (t && (O.node.isBlock(t) || O.node.isElement(t)) && ["TD", "TH"].indexOf(t.tagName) < 0) {
                    ...
                    n &&
                        ...
                        ((O.el === t && !r && O.opts.enter === V.ENTER_BR && O.browser.msie) || e.parentNode.removeChild(e));
                ...
                O.node.isEmpty(O.el) &&
                    (null !== d()
                        ? O.el.querySelector(p()) ||
                          O.el.querySelector("".concat(O.opts.htmlDoNotWrapTags.join(":not(.fr-marker),"), ":not(.fr-marker)")) ||
                          (O.core.hasFocus() ? (O.$el.html("<".concat(d(), ">").concat(V.MARKERS, "<br/></").concat(d(), ">")), O.selection.restore()) : O.$el.html("<".concat(d(), "><br/></").concat(d(), ">")))
                        : O.el.querySelector("*:not(.fr-marker):not(br)") || (O.core.hasFocus() ? (O.$el.html("".concat(V.MARKERS, "<br/>")), O.selection.restore()) : O.$el.html("<br/>")));
            }
            function C(e, t) {
            ...
            return {
                ...
                fillEmptyBlocks: function y(e) {
                    ...
                    for (var n = 0; n < t.length; n++) {
                        ...
                        "false" === r.getAttribute("contenteditable") ||
                            r.querySelector("".concat(O.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),"), ":not(.fr-marker)")) ||
                            O.node.isVoid(r) ||
                            ("TABLE" !== r.tagName && "TBODY" !== r.tagName && "TR" !== r.tagName && "UL" !== r.tagName && "OL" !== r.tagName && r.appendChild(O.doc.createElement("br")));
                    }
                ...
                get: function _(e, t) {
                                        ...
                                        for (o = 0; o < h.length; o++) {
                                            ...
                                            for (var g = 1e3 * d + $(c[f].selectorText), C = c[f].style.cssText.split(";"), m = 0; m < C.length; m++) {
                                                ...
                                                if (
                                                    v &&
                                                    !v.match(l) &&
                                                    (a[h[o]][v] || ((a[h[o]][v] = 0) <= (h[o].getAttribute("fr-original-style") || "").indexOf("".concat(v, ":")) && (a[h[o]][v] = 1e4)),
                                                    g >= a[h[o]][v] && ((a[h[o]][v] = g), C[m].trim().length))
                                                ) {
                    ...
                    if (O.node.isEmpty(O.el)) O.opts.fullPage && ((n = w(O.iframe_document)), (n += "<html".concat(O.node.attributes(O.$html.get(0)), ">").concat(O.$html.find("head").get(0).outerHTML, "<body></body></html>")));
                        ...
                        (O.opts.heightMin = null),
                            ...
                            O.size.refresh(),
                            (n += "<html".concat(O.node.attributes(O.$html.get(0)), ">").concat(O.$html.html(), "</html>")),
                            (O.opts.heightMin = T),
                            (O.opts.height = M),
                            (O.opts.heightMax = N),
                            O.size.refresh(),
                    ...
                    if ("undefined" != typeof O.win.getSelection) {
                        O.browser.mozilla &&
                            ...
                            1 < O.$el.find('.fr-marker[data-type="false"]').length &&
                                (O.$el.find('.fr-marker[data-type="false"][data-id="0"]').remove(), O.$el.find('.fr-marker[data-type="false"]:last').attr("data-id", "0"), O.$el.find(".fr-marker").not('[data-id="0"]').remove()),
                            O.selection.restore());
                        for (var o = O.selection.ranges(), i = 0; i < o.length; i++) {
                            ...
                            a.appendChild(o[i].cloneContents()),
                                e(
                                    ...
                                    (n = null),
                                    O.win.getSelection
                                        ? (t = O.win.getSelection()) && t.rangeCount && (n = t.getRangeAt(0).commonAncestorContainer).nodeType !== Node.ELEMENT_NODE && (n = n.parentNode)
                                        : (t = O.doc.selection) && "Control" !== t.type && (n = t.createRange().parentElement()),
                                    null !== n && (0 <= h(n).parents().toArray().indexOf(O.el) || n === O.el) ? n : null)
                                ),
                ...
                unwrap: function A() {
                    O.$el.find("div.fr-temp-div").each(function () {
                        this.previousSibling && this.previousSibling.nodeType === Node.TEXT_NODE && h(this).before("<br>"),
                            h(this).attr("data-empty") || !this.nextSibling || (O.node.isBlock(this.nextSibling) && !h(this.nextSibling).hasClass("fr-temp-div"))
        ...
        (V.MODULES.paste = function (N) {
            ...
            function e(e) {
                ...
                n(t, x(N.doc.createElement("div")).html(t).text()),
                    "cut" === e.type &&
                        (N.undo.saveStep(),
                        setTimeout(function () {
            ...
            function t(e) {
                ...
                if (e && e.clipboardData && e.clipboardData.getData) {
                    ...
                    if (N.helpers.isArray(n)) for (var r = 0; r < n.length; r++) t += "".concat(n[r], ";");
                    else t = n;
                    if (
                        ((a = ""),
                        ...
                        /text\/html/.test(t) && !N.browser.safari
                            ...
                            ? (a = s)
                            : /public.rtf/.test(t) && N.browser.safari && (a = e.clipboardData.getData("text/rtf")),
                        "" !== a)
                    )
                ...
                return (
                    (function o() {
                        N.selection.save(),
                            ...
                            (a = null),
                            i
                                ? (i.html(""), N.browser.edge && N.opts.iframe && N.$el.append(i))
                                : ((i = x(
                                  ...
                                  N.browser.webkit || N.browser.mozilla ? (i.css("top", N.$sc.scrollTop()), N.$el.after(i)) : N.browser.edge && N.opts.iframe ? N.$el.append(i) : N.$box.after(i),
                ...
                if (e && e.dataTransfer && e.dataTransfer.getData) {
                    ...
                    if (
                        ...
                        /text\/html/.test(t)
                            ...
                            : /text\/rtf/.test(t) && N.browser.safari
                            ? (a = s)
                            : /text\/plain/.test(t) && !this.browser.mozilla && (a = N.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")),
                        "" !== a)
                    ) {
                        ...
                        if (
                            (N.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"),
                            N.$el.find(".fr-marker-helper").addClass("fr-marker").removeClass("fr-marker-helper"),
                            N.selection.restore(),
                            N.selection.remove(),
                            N.$el.find(".fr-marker-placeholder").addClass("fr-marker").removeClass("fr-marker-placeholder"),
                            !1 !== o)
                        ) {
            ...
            function d() {
                N.opts.iframe && N.$el.attr("contenteditable", "true"),
                    ...
                    A || (N.keys.forceUndo(), (A = N.snapshot.get())),
                    a || ((a = i.get(0).innerHTML), N.selection.restore(), N.events.enableBlur());
            ...
            function o(e, t, n) {
                ...
                if (!t)
                    if (
                        ...
                        })(e)) && (e = N.win.localStorage.getItem("fr-copied-html")),
                        l)
                    )
                        e = N.clean.html(e, N.opts.pasteDeniedTags, N.opts.pasteDeniedAttrs);
                    else {
                        var c = N.opts.htmlAllowedStyleProps;
                        (N.opts.htmlAllowedStyleProps = N.opts.pasteAllowedStyleProps),
                            (N.opts.htmlAllowComments = !1),
                            (e = (e = (e = e.replace(/<span class="Apple-tab-span">\s*<\/span>/g, O(N.opts.tabSpaces || 4))).replace(/<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g, function (e, t) {
                                return O(t.length * (N.opts.tabSpaces || 4));
                            })).replace(/\t/g, O(N.opts.tabSpaces || 4))),
                            (e = N.clean.html(e, N.opts.pasteDeniedTags, N.opts.pasteDeniedAttrs)),
                            (N.opts.htmlAllowedStyleProps = c),
                            (N.opts.htmlAllowComments = !0),
                            (e = (e = (e = w(e)).replace(/\r/g, "")).replace(/^ */g, "").replace(/ *$/g, ""));
                    }
                !t ||
                    (N.wordPaste && n) ||
                    ...
                    (e = w(
                        (e = (function y(e) {
                            ...
                            (e = (e = e.replace(/<lilevel([^1])([^>]*)>/gi, '<li data-indent="true"$2>')).replace(/<lilevel1([^>]*)>/gi, "<li$1>")),
                                (e = (e = (e = N.clean.html(e, N.opts.pasteDeniedTags, N.opts.pasteDeniedAttrs)).replace(/<a>(.[^<]+)<\/a>/gi, "$1")).replace(/<br> */g, "<br>"));
                ...
                if (("string" == typeof d && (e = d), "" !== e)) {
                    ...
                    else if (N.opts.enter === V.ENTER_DIV) for (r = (o = f.getElementsByTagName("p")).length - 1; 0 <= r; r--) 0 === (i = o[r]).attributes.length && (i.outerHTML = "<div>".concat(i.innerHTML, "</div>"));
            ...
            function w(e) {
                ...
                for (var r = f(Array.prototype.slice.call(n.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])"))); r.length; ) {
                    ...
                    if (N.html.defaultTag() && "div" !== N.html.defaultTag())
                        o.querySelector(N.html.blockTagsQuery()) ? (o.outerHTML = o.innerHTML) : (o.outerHTML = "<".concat(N.html.defaultTag(), ">").concat(o.innerHTML, "</").concat(N.html.defaultTag(), ">"));
                    else {
        ...
        (V.MODULES.popups = function (f) {
            ...
            function o(e) {
                ...
                e.find(".fr-upload-progress").addClass("fr-height-set"),
                    ...
                    f.popups.get("filesManager.insert").removeClass("fr-height-auto"),
            ...
            function c(e, t) {
                ...
                "filesManager.insert" === e
                    ? o.addClass("fr-popup fr-files-manager".concat(f.helpers.isMobile() ? " fr-mobile" : " fr-desktop").concat(f.opts.toolbarInline ? " fr-inline" : ""))
                ...
                (f.shared.exit_flag = !1),
                {
                    _init: function y() {
                        (r = window.innerHeight),
                            ...
                            f.events.on("window.touchmove", v),
                            f.events.$on(d(f.o_win), "scroll", v),
                    ...
                    create: function S(e, t) {
                        ...
                        return (
                            ...
                            f.events.$on(n, "click", ".fr-checkbox + label", E),
                            ...
                            "filesManager.insert" === e && u["filesManager.insert"].css("zIndex", 2147483641),
                            n
                        );
                    },
                    get: function T(e) {
                    ...
                    show: function M(e, t, n, r, o) {
                        ...
                        s.is(f.$tb) ? f.$tb.css("zIndex", (f.opts.zIndex || 1) + 4) : u[e].css("zIndex", (f.opts.zIndex || 1) + 3),
                    ...
                    setPopupDimensions: function w(e, t) {
                        t &&
                            ...
                            (e.find(".fr-upload-progress").addClass("fr-height-auto"), f.popups.get("filesManager.insert").addClass("fr-height-auto"), e.find(".fr-upload-progress").removeClass("fr-height-set"), (i = 2e3)),
            ...
            function o() {
                ...
                if ((0 === e.top && 0 === e.left && 0 === e.width) || 0 === e.height) {
                    ...
                    n.css("display", "none"),
                        ...
                        (e.width = 0),
                        (e.height = o),
                        (e.top = r && r.top - ((L.helpers.isMobile() && !L.helpers.isIOS()) || L.opts.iframe ? 0 : L.helpers.scrollTop())),
                        (e.right = 1),
                        (e.bottom = 1),
                        (e.ok = !0),
                    ...
                    !(function e() {
                        (L._stickyElements = []),
                            L.helpers.isIOS()
                                ...
                                : ("body" !== L.opts.scrollableContainer && L.events.$on(E(L.opts.scrollableContainer), "scroll", a, !0),
        ...
        (V.MODULES.toolbar = function (C) {
            ...
            function r() {
                if (m !== C.helpers.screenSize()) {
                    ...
                    (function g() {
                        for (
                            var t = C.$tb.find(".fr-btn-grp, .fr-more-toolbar"),
                                r = function r(e) {
                                    var n = v(t[e]);
                        ...
                        if (o.buttons) {
                            ...
                            for (var c = 0; c < o.buttons.length; c++) {
                                ...
                                var d = C.$tb.find('> .fr-command[data-cmd="' + o.buttons[c] + '"], > div.fr-btn-wrap > .fr-command[data-cmd="' + o.buttons[c] + '"]'),
                                    f = null;
                                C.node.hasClass(d.next().get(0), "fr-dropdown-menu") && (f = d.next()),
                                    C.node.hasClass(d.next().get(0), "fr-options") && (d.removeClass("fr-hidden"), d.next().removeClass("fr-hidden"), (d = d.parent())),
                    ...
                    C.opts.toolbarBottom
                        ? (C.$tb.append(n), C.$tb.find(".fr-newline").remove(), C.$tb.append('<div class="fr-newline"></div>'), C.$tb.append(t))
                        : (C.$tb.append(t), C.$tb.find(".fr-newline").remove(), C.$tb.append('<div class="fr-newline"></div>'), C.$tb.append(n)),
                        C.$tb.removeClass("fr-toolbar-open"),
                        C.$box.removeClass("fr-toolbar-open"),
                        C.events.trigger("codeView.toggle");
                }
                L();
            }
            function n(e, t) {
                setTimeout(function () {
                    if (
                        ...
                        C.selection.inEditor() &&
                        C.core.hasFocus() &&
                        !C.popups.areVisible() &&
                        "false" != v(C.selection.blocks()[0]).closest("table").attr("contenteditable") &&
                        (C.opts.toolbarVisibleWithoutSelection || (!C.selection.isCollapsed() && !C.keys.isIME()) || t)
                    ) {
            ...
            function o(e) {
                return (
                    (!e || "blur" !== e.type || document.activeElement !== C.el) &&
                    (!(!e || "keydown" !== e.type || !C.keys.ctrlKey(e)) || !!C.button.getButtons(".fr-dropdown.fr-active").next().find(C.o_doc.activeElement).length || void (!1 !== C.events.trigger("toolbar.hide") && C.$tb.hide()))
                );
            }
            (t[V.XS] = e(C.opts.toolbarButtonsXS || C.opts.toolbarButtons || V.TOOLBAR_BUTTONS_XS || V.TOOLBAR_BUTTONS || [])),
                (t[V.SM] = e(C.opts.toolbarButtonsSM || C.opts.toolbarButtons || V.TOOLBAR_BUTTONS_SM || V.TOOLBAR_BUTTONS || [])),
                (t[V.MD] = e(C.opts.toolbarButtonsMD || C.opts.toolbarButtons || V.TOOLBAR_BUTTONS_MD || V.TOOLBAR_BUTTONS || [])),
                (t[V.LG] = e(C.opts.toolbarButtons || V.TOOLBAR_BUTTONS || []));
            var i = null;
            function a(e) {
                clearTimeout(i), (e && e.which === V.KEYCODE.ESC) || (i = setTimeout(n, C.opts.typingTimer));
            }
            function s() {
                C.events.on("window.mousedown", o),
                    C.events.on("keydown", o),
                    C.events.on("blur", o),
                    C.events.$on(C.$tb, "transitionend", ".fr-more-toolbar", function () {
                        C.position.forSelection(C.$tb);
                    }),
                    C.helpers.isMobile() || C.events.on("window.mouseup", n),
                    C.helpers.isMobile() ? C.helpers.isIOS() || (C.events.on("window.touchend", n), C.browser.mozilla && setInterval(n, 200)) : C.events.on("window.keyup", a),
                    ...
                    C.events.$on(C.$wp, "scroll.toolbar", n),
                    C.events.on("commands.after", n),
                    C.helpers.isMobile() && (C.events.$on(C.$doc, "selectionchange", a), C.events.$on(C.$doc, "orientationchange", n));
            }
            function l() {
            ...
            function d() {
                C.opts.theme && C.$tb.addClass("".concat(C.opts.theme, "-theme")),
                    1 < C.opts.zIndex && C.$tb.css("z-index", C.opts.zIndex + 1),
                    "auto" !== C.opts.direction && C.$tb.removeClass("fr-ltr fr-rtl").addClass("fr-".concat(C.opts.direction)),
                    C.helpers.isMobile() ? C.$tb.addClass("fr-mobile") : C.$tb.addClass("fr-desktop"),
                    C.opts.toolbarContainer
                        ? (C.opts.toolbarInline && (s(), o()), C.opts.toolbarBottom ? C.$tb.addClass("fr-bottom") : C.$tb.addClass("fr-top"))
                        : (function e() {
                              C.opts.toolbarInline
                                  ? (C.$sc.append(C.$tb), C.$tb.data("container", C.$sc), C.$tb.addClass("fr-inline"), s(), (C.opts.toolbarBottom = !1))
                                  : (C.opts.toolbarBottom && !C.helpers.isIOS()
                                        ? (C.$box.append(C.$tb), C.$tb.addClass("fr-bottom"), C.$box.addClass("fr-bottom"))
                                        : ((C.opts.toolbarBottom = !1), C.$box.prepend(C.$tb), C.$tb.addClass("fr-top"), C.$box.addClass("fr-top")),
                                    C.$tb.addClass("fr-basic"),
                                    C.opts.toolbarSticky &&
                                        (C.opts.toolbarStickyOffset && (C.opts.toolbarBottom ? C.$tb.css("bottom", C.opts.toolbarStickyOffset) : C.$tb.css("top", C.opts.toolbarStickyOffset)), C.position.addSticky(C.$tb)));
                          })(),
                    (function t() {
                    ...
                    C.accessibility.registerToolbar(C.$tb),
                    C.events.$on(
                        C.$tb,
                        "".concat(C._mousedown, " ").concat(C._mouseup),
                        function (e) {
                    ...
                    C.helpers.isMobile() &&
                        C.events.$on(C.$tb, "click", function () {
                            C.$el.focus();
                        }),
                    C.events.$on(C.$tb, "transitionend", ".fr-more-toolbar", function () {
            ...
            return {
                _init: function p() {
                    ...
                    C.opts.toolbarInline ||
                        C.opts.toolbarBottom ||
                        ((C.$second_tb = v(C.doc.createElement("div")).attr("class", "second-toolbar")), C.$box.append(C.$second_tb), (!1 !== C.ul || C.opts.attribution) && C.$second_tb.prepend(V.POWERED_BY)),
                        C.opts.toolbarContainer
                            ? (C.shared.$tb
                                  ? ((C.$tb = C.shared.$tb), C.opts.toolbarInline && s())
                                  : ((C.shared.$tb = v(C.doc.createElement("DIV"))), C.shared.$tb.addClass("fr-toolbar"), (C.$tb = C.shared.$tb), v(C.opts.toolbarContainer).append(C.$tb), d(), C.$tb.data("instance", C)),
                              C.opts.toolbarInline ? C.$box.addClass("fr-inline") : C.$box.addClass("fr-basic"),
                              C.events.on(
                                  "focus",
                                  function () {
                              ...
                              (C.opts.toolbarInline = !1))
                            : C.opts.toolbarInline
                            ? (C.$box.addClass("fr-inline"), C.shared.$tb ? ((C.$tb = C.shared.$tb), s()) : ((C.shared.$tb = v(C.doc.createElement("DIV"))), C.shared.$tb.addClass("fr-toolbar"), (C.$tb = C.shared.$tb), d()))
                            : (C.$box.addClass("fr-basic"), (C.$tb = v(C.doc.createElement("DIV"))), C.$tb.addClass("fr-toolbar"), d(), C.$tb.data("instance", C)),
                        C.events.on("destroy", c, !0),
                        C.events.on(C.opts.toolbarInline || C.opts.toolbarContainer ? "shared.destroy" : "destroy", l, !0),
                        C.events.on("edit.on", function () {
                        ...
                        (function e() {
                            C.events.on("shortcut", function (e, t, n) {
                                var r;
                                if (
                                    (t && !n ? (r = C.$tb.find('.fr-command[data-cmd="'.concat(t, '"]'))) : t && n && (r = C.$tb.find('.fr-command[data-cmd="'.concat(t, '"][data-param1="').concat(n, '"]'))),
                                    r.length && (e.preventDefault(), e.stopPropagation(), r.parents(".fr-toolbar").data("instance", C), "keydown" === e.type))
                                )
                                    return C.button.exec(r), !1;
                            });
                        })();
                },
                hide: o,
    ...
    (h.fn = h.prototype = {
        ...
        parents: function (e) {
            for (var t = m(), n = 0; n < this.length; n++) for (var r = this[n].parentNode; r && r != document && r.matches; ) e ? r.matches(e) && t.push(r) : t.push(r), (r = r.parentNode);
            return t;
        },
    ...
    function L() {
        (this.doc = this.$el.get(0).ownerDocument),
            ...
            this.opts.initOnClick
                ...
                : (this.load(b.MODULES), this.load(b.PLUGINS), h(this.o_win).scrollTop(this.c_scroll), "undefined" == typeof this.ul && this.destroy(), (this.ready = !0), this.events.trigger("initialized"));
    }
    return (
        (b.Bootstrap = function (e, t, n) {
            ...
            "function" == typeof t && ((n = t), (t = {})),
                ...
                (this.opts = Object.assign({}, Object.assign({}, b.DEFAULTS, r, "object" === N(t) && t)));
