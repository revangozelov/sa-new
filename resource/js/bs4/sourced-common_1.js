                            ...
                            .append($('<div class="dropdown" style="display: inline-block;">')
                                    ...
                                    .append($('<div class="dropdown-menu uuu" aria-labelledby="dropdownMenuLink">')
                                            .append($('<button class="dropdown-item firstbut" >')
                                                    .text('Edit')
                                                    .attr("onclick", "editBacklogDesc(this)")
                                                    )
                                            .append($('<button class="dropdown-item firstbut" >')
    ...
    getTableHeader4InputTable: function (trcount) {
        ...
        var thead = $('<thead></thead>')
                .append($('<tr></tr>')
                        ...
                        .append($('<th></th>').attr('style', 'width:200px;background-color: #ffffff;').append('Input name'))
...
<hr style="margin:0px" class="is-api-dependence">\n\
<button class="dropdown-item is-api-dependence" style="color:#000000" data-toggle="modal" data-target="#addRelatedSourceModal" onclick="new UserStory().addRelationSourcedModal(this,\'send\',\'' + obj[i].id + '\')">Send/Save Data To API</button>\n\
<button class="dropdown-item is-api-dependence" style="color:#000000" onclick="new UserStory().removeSendSaveTo(this,\'' + obj[i].id + '\')">Remove Send/Save Data To</button>\n\
</div>\n\
</div>'
                            + '</div>'));
            ;
