...
//            concole.log()
    ...
    showStoryDiagram: function () {
        ...
        $('#analytics_toggleneefdiagram').prop('checked', true);
        this.toggleNEEFDiagram($('#analytics_toggleneefdiagram'));

    },

    showInputDiagram: function () {
        $('#activityDiagramDiv').html('');
        this.showPanel();
        this.clearArrays();
        this.fillArrays();
        ...
        $('#analytics_toggleinput').prop('checked', true);
        this.toggleInput($('#analytics_toggleinput'));

        $('#analytics_toggleuserstory').prop('checked', false);
